...
@SuppressLint("NewApi")
public class BettingRecordsFragment extends Fragment {
	public final String tag = this.getClass().getName();
	private Context text = null;

	public BettingRecordsFragment(Context text) {
		this.text = text;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// inflater the layout
		JXCApplication.accNumber = 1;
		View view = inflater.inflate(R.layout.fragment_betting_records, null);
